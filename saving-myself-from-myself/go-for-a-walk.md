...
title: "go-for-a-walk"
slug: go-for-a-walk
permalink: /saving-myself-from-myself/go-for-a-walk/
tagline: "A gentle nudge to step away when the user has been in deep work for a while. Named after an actual daily habit — the skill fits an existing pattern rather than imposing a new one."
triggers:
  - should I take a break
  - am I overdoing this
  - (watches the session itself)
source_url: https://github.com/usefulish/usefulish/blob/main/skills/saving-myself-from-myself/go-for-a-walk/SKILL.md
---
